<html>
<head>
  <title>Pay Premium -:- [airespaker] AI Response Taker</title>
...
function g_resize() {
  ...
  $('#page-o .dtt-page-inner').css( 'minHeight', '3200px');
  $('#page-o .dtt-page-inner').css( 'minWidth', '640px');
  if ( sw <= 640 ) {
    $('.dtt-page').css( 'overflowX', 'auto');
  } else {
    $('.dtt-page').css( 'overflowX', 'hidden');
  }
...
<body onload="g_load()">
  ...
  <div class="dtt-page"><div class="dtt-page-inner">=======_==========================_============
...
+ Unlimited AI responses creation

+ Unlimited tags creation
...
o Tap on "Add to cart" button
    
<div style="width: 640px; height: 400px; border: dotted 2px gainsboro; overflow: hidden"><a target="_blank" href="https://airespaker.is-best.net/premium-01.png"><img style="width: 640px;" src="https://airespaker.is-best.net/premium-01.png" /></a></div>

o First Name: Dinh Thoai
...
o Delivery Method: Send by email
  _o_ Recipient Email: attaceph@protonmail.com
